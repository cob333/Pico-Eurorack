// DaisySP delay line subset packaged for the 2HPico DaisySP_Delay sketch.
//
// Original DaisySP DelayLine by Stephen Hensley, 2019.
// Contributor: Wenhao Yang
//
// This local header keeps DaisySP_Delay independent from an external DaisySP
// library install while preserving the daisysp::DelayLine API used by the sketch.

#pragma once
#ifndef TWOHPICO_DAISYSP_DELAY_H
#define TWOHPICO_DAISYSP_DELAY_H
