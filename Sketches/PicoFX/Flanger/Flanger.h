// DaisySP flanger dependency subset packaged for the 2HPico DaisySP_Flanger sketch.
//
// Original DaisySP DelayLine by Stephen Hensley, 2019.
// Contributor: Wenhao Yang
//
// This local header keeps DaisySP_Flanger independent from an external DaisySP
// library install while preserving the daisysp::DelayLine and daisysp::fclamp
// APIs used by the sketch's PicoFlanger class.

#pragma once
#ifndef TWOHPICO_DAISYSP_FLANGER_H
#define TWOHPICO_DAISYSP_FLANGER_H
