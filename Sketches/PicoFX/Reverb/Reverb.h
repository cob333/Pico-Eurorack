// DaisySP reverb subset packaged for the 2HPico DaisySP_Reverb sketch.
//
// Original DaisySP ReverbSc port by Stephen Hensley.
// Contributor: Wenhao Yang
//
// This local header keeps DaisySP_Reverb independent from an external DaisySP
// library install while preserving the daisysp::ReverbSc API used by the sketch.

#pragma once
#ifndef TWOHPICO_DAISYSP_REVERB_H
#define TWOHPICO_DAISYSP_REVERB_H
